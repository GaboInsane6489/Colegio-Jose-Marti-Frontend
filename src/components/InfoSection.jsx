...
const InfoSection = () => {
  ...
  return (
    <section ref={ref} className='w-full bg-[#f8f8f8] text-[#1a1a1a] px-4 sm:px-6 py-12 sm:py-16'>
      <motion.div
      ...
      >
        ...
        <motion.h2
          ...
          className='text-2xl sm:text-3xl md:text-4xl font-bold mb-6 tracking-tight drop-shadow-[0_0_6px_rgba(0,0,0,0.2)]'
        >
        ...
        <motion.p
          ...
          className='text-sm sm:text-base md:text-lg text-[#333] mb-12 max-w-3xl mx-auto px-2'
        >
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-2 sm:px-6 mb-12'>
          {[
            {
              icon: <FaUserGraduate />,
            ...
            >
              <div className='text-4xl sm:text-5xl text-[#1a1a1a] mb-4 drop-shadow-sm'>{icon}</div>
              <h3 className='font-semibold text-base sm:text-lg mb-2'>{title}</h3>
              <p className='text-sm sm:text-base text-[#555] leading-relaxed'>{text}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <a
            href='/nosotros'
            className='inline-block bg-[#1a1a1a] text-white px-6 py-3 rounded-full font-medium text-sm sm:text-base transition-all duration-300 hover:shadow-[0_0_16px_#e0b400] hover:text-white drop-shadow-[0_0_6px_#000000]'
          >
