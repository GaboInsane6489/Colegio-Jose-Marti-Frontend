...
const NotificacionesDocente = () => {
  ...
  return (
    <section className='bg-black/60 text-white p-6 rounded-xl border border-white/20 shadow-md w-full max-w-2xl mx-auto flex flex-col items-center justify-center space-y-6 text-center'>
