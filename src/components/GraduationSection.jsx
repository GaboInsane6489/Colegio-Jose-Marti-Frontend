    ...
    >
      ...
      >
        <motion.h2
          ...
          className='text-2xl sm:text-3xl md:text-5xl font-bold mb-6 drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]'
        >
        ...
        <motion.p
          ...
          className='text-base sm:text-lg md:text-xl text-white/90 mb-8 drop-shadow-[0_0_4px_rgba(0,0,0,0.6)]'
        >
        ...
        >
          <a
            href='/graduaciones'
            className='inline-block bg-[#1a1a1a] text-white px-6 py-3 rounded-full font-medium text-base sm:text-lg transition-all duration-300 hover:shadow-[0_0_16px_#ffffff] hover:text-[#ffffff] drop-shadow-[0_0_6px_#ffffff]'
          >
