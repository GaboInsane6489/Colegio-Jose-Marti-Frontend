...
import { exportNotasCSV } from '@/utils/exportadores/exportNotasCSV.js';
...
const NotasPage = () => {
  ...
  const { data: cursos } = useCursos('docente'); // hook institucional para cursos
      ...
      <main className='relative z-20 px-4 sm:px-6 py-16 sm:py-24 max-w-6xl mx-auto space-y-12'>
        ...
        <div className='flex justify-center items-center gap-4'>
          <select
            ...
            className='bg-black border border-white/30 px-4 py-2 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#00FFF7] hover:scale-110 hover:-translate-y-[2px] transition duration-300'
          >
        ...
        {filtroCursoId && estudiantesUnicos.length > 0 && (
          <section className='pt-12 space-y-6'>
            <h2 className='text-2xl font-bold text-center flex justify-center items-center gap-2 text-white drop-shadow-[0_0_6px_#00FFF7]'>
